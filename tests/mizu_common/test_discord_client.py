...
def test_discord_embed_to_dict_with_all_fields() -> None:
    """DiscordEmbed.to_dictが全フィールドを含む辞書を返すこと.
...
def test_discord_embed_to_dict_with_minimal_fields() -> None:
    """DiscordEmbed.to_dictが最小フィールドのみで正しい辞書を返すこと.
